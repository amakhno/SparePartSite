...
namespace My_Site.Controllers
{
    public partial class SparePartController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SparePartController Actions { get { return MVC.SparePart; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SparePart";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SparePart";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SparePartController : My_Site.Controllers.SparePartController
    {
        public T4MVC_SparePartController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string category, int page);
        ...
        public override System.Web.Mvc.ActionResult List(string category, int page)
        {
            ...
            ListOverride(callInfo, category, page);
            return callInfo;
        }
