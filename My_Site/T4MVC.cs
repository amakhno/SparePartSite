...
{
    public static My_Site.Controllers.AccountController Account = new My_Site.Controllers.T4MVC_AccountController();
    public static My_Site.App_Start.AdminController Admin = new My_Site.App_Start.T4MVC_AdminController();
    public static My_Site.Controllers.CartController Cart = new My_Site.Controllers.T4MVC_CartController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string My_scripts_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/My_scripts.min.js") ? Url("My_scripts.min.js") : Url("My_scripts.js");
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            public static class Assets
            {
                ...
                public const string My_scripts_js = "~/Scripts/My_scripts.js"; 
